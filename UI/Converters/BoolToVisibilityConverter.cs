...
namespace QB_TimeWarp.UI.Converters
{
    ...
    /// <summary>
    /// Compares a bound string (Category) to the ConverterParameter.
    /// Returns Visible when they match, Collapsed otherwise.
    /// Usage: Visibility="{Binding Category, Converter={StaticResource CategoryVis}, ConverterParameter=List}"
    /// </summary>
